...
> Пролог: данная шпаргалка была написана в течение прочтения автором книги "Изучаем vi и Vim редакторы. 7-е изд." в vim, конечено же). Советую использовать её как памятка уже после прочтения книги. В репозитории содержится pdf версия шпаргалки для желающих распечатать её. 
